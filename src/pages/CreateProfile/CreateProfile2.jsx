  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const [hasIdea, industryInterests, areasOfResponsibility] =
          await Promise.all([
            getHasIdea(),
            getIndustryInterests(),
            getAreasOfResponsibility(),
    ...
    <>
      ...
      >
        ...
        <form onSubmit={handleSubmit} style={{ marginTop: "150px" }}>
          ...
          <label htmlFor="connectionInterest">
          ...
          <label htmlFor="interestedInBeingACofounder">
          ...
          {/* Industry Interests */}
          <label htmlFor="industryInterests">
          ...
          <label htmlFor="areasOfResponsibility">
          ...
          {/* Potential Ideas */}
          <label htmlFor="potentialIdeas">
            If you have any business ideas, what are some you might like to work
            on?
          </label>
          <br />
          <TextField.Root
          ...
          <label htmlFor="cofounderDesiredQualities">
