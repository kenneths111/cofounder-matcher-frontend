    ...
    const fetchData = async () => {
      try {
        ...
        if (hasIdea && Array.isArray(hasIdea.data)) {
          ...
          console.error(
            "Expected hasIdea.data to be an array, got:",
            hasIdea.data
          );
        }
        ...
        if (industryInterests && Array.isArray(industryInterests.data)) {
          ...
          console.error(
            "Expected industryInterests.data to be an array, got:",
            industryInterests.data
          );
        }
        ...
        if (
          areasOfResponsibility &&
          Array.isArray(areasOfResponsibility.data)
        ) {
          setAreasOfResponsibility(areasOfResponsibility.data);
        } else {
          console.error(
            "Expected areasOfResponsibility.data to be an array, got:",
        ...
        if (programTypes && Array.isArray(programTypes.data)) {
          ...
          console.error(
            "Expected programTypes.data to be an array, got:",
            programTypes.data
          );
        }
        ...
        if (schools && Array.isArray(schools.data)) {
          ...
          console.error(
            "Expected schools.data to be an array, got:",
            schools.data
          );
        }
      } catch (error) {
        ...
        >
          ...
          >
            ...
            <TextField.Root
              ...
              onChange={handleChange}
              placeholder="Tell us about your background, interests, career, and what you're looking for on this app"
            >
              <TextField.Slot />
            </TextField.Root>
            <br />
            ...
            <Text htmlFor="impressiveAccomplishmnet">
              Brag About an Impressive Accomplishment
            </Text>
            <br />
            <TextField.Root
              id="impressiveAccomplishmnet"
              name="impressiveAccomplishmnet"
              value={profileData.impressiveAccomplishmnet}
              onChange={handleChange}
              placeholder="Impressive Accomplishment"
            >
              <TextField.Slot />
            </TextField.Root>
            <br />
            ...
            <Text htmlFor="connectionInterest">
              What kinds of connections are you looking for on this app?
            </Text>
            <br />
            <TextField.Root
              id="connectionInterest"
              name="connectionInterest"
              value={profileData.connectionInterest}
              onChange={handleChange}
              placeholder="e.g. I'm looking to meet a technical cofounder for a business venture in the healthcare space"
            >
              <TextField.Slot />
            </TextField.Root>
            <br />
            ...
            <Text htmlFor="interestedInBeingACofounder">
              Are you interested in starting a business or finding a cofounder?
            </Text>
            <br />
            <>
              <Select.Root
                id="interestedInBeingACofounder"
                name="interestedInBeingACofounder"
                value={profileData.interestedInBeingACofounder}
                onValueChange={(value) =>
                  handleChange({
                    target: { name: "interestedInBeingACofounder", value },
                  })
                }
              >
                <Select.Trigger />
            ...
            {/* Industry Interests */}
            <Text htmlFor="industryInterests">
            ...
            >
              <CheckboxGroup.Root
                ...
                onValueChange={(values) =>
                  handleChange({
                    target: { name: "industryInterests", value: values },
                  })
                }
              >
            ...
            <Text htmlFor="areasOfResponsibility">
            ...
            <CheckboxGroup.Root
              ...
              onValueChange={(values) =>
                handleChange({
                  target: { name: "areasOfResponsibility", value: values },
                })
              }
            >
            ...
            {/* HasIdea */}
            <Text htmlFor="hasIdea">
              Do you have a business idea you want to work on?
            </Text>
            <br />
            <select
              id="hasIdea"
              name="hasIdea"
              value={profileData.hasIdea}
              onChange={handleChange}
            >
            ...
            {/* Potential Ideas */}
            <Text htmlFor="potentialIdeas">
              If you have any business ideas, what are some you might like to
              work on?
            </Text>
            <br />
            <TextField.Root
              id="potentialIdeas"
              name="potentialIdeas"
              value={profileData.potentialIdeas}
              onChange={handleChange}
              placeholder="e.g. I have an idea for a mobile app that helps people find the best local restaurants"
            >
              <TextField.Slot />
            </TextField.Root>
            <br />
            ...
            <Text htmlFor="cofounderDesiredQualities">
              What qualities are you looking for in a cofounder?
            </Text>
            <br />
            <TextField.Root
              id="cofounderDesiredQualities"
              name="cofounderDesiredQualities"
              value={profileData.cofounderDesiredQualities}
              onChange={handleChange}
              placeholder="e.g. I'm looking for someone who is passionate about technology and has experience in marketing"
            >
              <TextField.Slot />
            </TextField.Root>
            <br />
